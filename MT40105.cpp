...
void MT40105::Draw(){
	...
	Novice::ScreenPrintf(0, 60,  "%.2f %.2f %.2f %.2f	:	interpolate3, Slerp(q0,q1,0.7f)", interpolate3.x, interpolate3.y, interpolate3.z, interpolate3.w);
	Novice::ScreenPrintf(0, 80,  "%.2f %.2f %.2f %.2f	:	interpolate4, Slerp(q0,q1,1.0f)", interpolate4.x, interpolate4.y, interpolate4.z, interpolate4.w);
}